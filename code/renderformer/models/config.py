...
class RenderFormerConfig:
    ...
    """Whether to use GP-Sparse attention instead of dense attention."""
    sparse_k_local: int = 64
    """k-NN neighbors for local branch in sparse attention."""
    sparse_k_selected: Optional[int] = None
    """Top-k blocks for selected branch in sparse attention."""
    sparse_use_normal_mask: bool = True
    """Whether to use normal-coherence masking in sparse attention."""
